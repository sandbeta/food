...
const MOTIVATIONS = [
  '今天的你和美食都很甜呀～', '被喂饱的小朋友才有力气撒娇呀',
  '恋爱可以慢慢谈，饭要趁热吃噢～', '不吃饭的女孩子会变成小怪兽的！',
  '这一口，是大厨给你最好的奖励～', '心情不好的时候，就让胃先快乐起来吧',
  '吃饱了才有力气撒娇呀～', '每天都有好好吃饭，超棒的！',
  '本可爱决定爱这顿饭，从第一口开始~', '对全世界温柔，不如让胃先幸福一点呀',
  '今日份的快乐正在加载中...', '好好吃饭，是被爱的小证据呀',
  '女孩子要吃甜甜的才会有好心情呀', '好好吃饭就是头等大事，不接受反驳！',
  '胃满了，心就暖啦～', '再忙也要记得宠幸小胃胃哦',
  '想吃就是身体在撒娇呀，大厨收到～', '美食和爱一样，都值得期待呀',
  '这一顿，是今天最治愈的时刻～', '吃饱饱，烦恼全跑掉！',
  '今天的胃，由大厨亲自照顾～', '把喜欢的东西都装进肚子里吧',
  '女孩子就是要被宠呀，想吃就吃！', '和喜欢的一切在一起，包括这顿饭～',
]
